...
public class TotalFreedomMod extends JavaPlugin
{
    ...
    public void onEnable()
    {
                            ...
                            TFM_Log.info("*   Origanally made by Madgeek1450 and DarthSalamon *", true);
                            TFM_Log.info("* - - - - - - - - - - - - - - - - - - - - - - - - - *", true);
                            TFM_Log.info("* Later modified by packeretteswan for PacksFreedom *", true);
                            TFM_Log.info("*               Running server normally             *", true);
                            TFM_Log.info("*****************************************************", true);
    ...
    public void onDisable()
    {
        ...
        TFM_BanManager.save();
                            ...
                            TFM_Log.info("* - - - - - - - - - - - - - - - - - - - - - - - - - *", true);
                            TFM_Log.info("* Later modified by packeretteswan for PacksFreedom *", true);
                            TFM_Log.info("*               Server shutting down                *", true);
                            TFM_Log.info("*****************************************************", true);
    }
