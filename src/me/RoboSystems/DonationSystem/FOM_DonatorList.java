...
{
  private static final Map<String, FOM_Donator> donatorList = new HashMap();
  ...
  private static int clean_threshold_hours = 168;
    private static List<String> superDonatorNames;
    private static boolean is_full_donator;
  ...
  public static void saveDonatorList()
  {
    try
    {
      ...
      while (it.hasNext())
      {
        ...
        config.set("donators." + donator_name + ".is_super_donator", donator.isSuperDonator());
